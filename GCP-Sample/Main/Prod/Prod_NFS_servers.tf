...
module  "Prod_NFS_server" {
  ...
  subnetwork = module.prod_subnet.vpc_subnet
...
module  "Prod_NFS_client" {
  ...
  metadata = {nfs-server-name = "${module.Prod_NFS_server.instance_name}"}
  }


output "internal_ip_server" {
  value = module.Prod_NFS_server.internal_ip
} 

output "external_ip_server" {
  value = module.Prod_NFS_server.external_ip
} 

output "instance_name_server" {
  value = module.Prod_NFS_server.instance_name
}

output "internal_ip_client" {
  value = module.Prod_NFS_client.internal_ip
} 

output "external_ip_client" {
  value = module.Prod_NFS_client.external_ip
} 

output "instance_name_client" {
  value = module.Prod_NFS_client.instance_name
}
